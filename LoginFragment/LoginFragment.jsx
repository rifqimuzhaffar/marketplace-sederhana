...
import Modal from '../../Elements/Modals/ModalLogin/Modal';

const LoginFragment = ({ Handlerclosemodal }) => {
    return (
      <>
      <Modal>
      ...
      <div className="w-full rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
             <p className='text-left text-white cursor-pointer' onClick={Handlerclosemodal}>close</p>
              ...
              <form className="space-y-4 md:space-y-6" action="#">
                  ...
                  <div>
                      ...
                      <input type="text" name="" id="" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@company.com" required="" />
                  </div>
                  ...
                  <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                      Don’t have an account yet? <a href="#" className="font-medium text-primary-600 hover:underline dark:text-primary-500"> <span className='text-white'>Sign up</span></a>
                  </p>
              </form>
          </div>
      </div>
